    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <motion.h1
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-ic-dark-blue mb-6 leading-tight font-heading"
          ...
          <motion.p
            className="text-xl sm:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12 font-body"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.6 }}
          >
            Discover how IC Digital Solutions has helped businesses across industries transform their operations with
            AI-powered solutions, achieving measurable ROI and competitive advantages.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <h3 className="font-semibold text-ic-dark-blue mb-2 font-heading">50+ Projects</h3>
              <p className="text-gray-600 text-center text-sm font-body">Successfully delivered AI solutions</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-ic-dark-blue mb-2 font-heading">25+ Clients</h3>
              <p className="text-gray-600 text-center text-sm font-body">Across diverse industries</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-semibold text-ic-dark-blue mb-2 font-heading">95% Success Rate</h3>
              <p className="text-gray-600 text-center text-sm font-body">Client satisfaction and ROI achievement</p>
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
